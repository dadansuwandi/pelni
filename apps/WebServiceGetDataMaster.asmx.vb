...
Public Class WebServiceGetDataMaster
    ...
    ''PELNI ENHANCE
    '' By Restu 01-05-2024
    ''#Nambah 1 Level Turunan Case menjadi 4 Level
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function OnChangeTransactionTrmCategoryTopicDetail(ByVal TrxID As String, ByVal TrxUserName As String, ByVal TrxName As String, ByVal TrxStatus As String) As String
        Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim dt As DataTable = New DataTable()

        Dim TrxAction As String = "CHANGEDETAIL"
        Dim NameSP = "Exec UIDESK_TrxCategoryDetail_2_1"
        Dim ExecSP = "" & NameSP & " '-','0','0','" & TrxUserName & "','" & TrxName & "','" & TrxStatus & "','" & TrxAction & "'"
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                conn.Open()
                Dim sqlComm As SqlCommand = New SqlCommand("UIDESK_TrxCategoryDetail_2_1", conn)
                sqlComm.Parameters.AddWithValue("@TrxID", TrxID)
                sqlComm.Parameters.AddWithValue("@TrxCategoryID", "0")
                sqlComm.Parameters.AddWithValue("@TrxSubCategory1ID", "0")
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function OnChangeTransactionTrmCategoryTopic(ByVal TrxID As String, ByVal TrxUserName As String, ByVal TrxName As String, ByVal TrxStatus As String) As String
        Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim dt As DataTable = New DataTable()
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function TableTransactionTrmCategoryDetail_2_1(ByVal TrxID As String, ByVal TrxUserName As String, ByVal TrxName As String, ByVal TrxStatus As String) As String
        Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim dt As DataTable = New DataTable()
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function InsertTransactionTrmCategoryDetail_2_1(ByVal TrxCategoryID As String, ByVal TrxSubCategory1ID As String, ByVal TrxSubCategory2ID As String, ByVal TrxName As String,
                                                     ByVal TrxStatus As String, ByVal TrxUserName As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxCategoryDetail_2_1 '0','" & TrxCategoryID & "','" & TrxSubCategory1ID & "','" & TrxSubCategory2ID & "','" & AntiXssEncoder.HtmlEncode(TrxName.Trim, True) & "','" & TrxStatus & "','" & UserNameXSS & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function TableTransactionTrmCategoryReason(ByVal TrxID As String, ByVal TrxCategoryID As String, ByVal TrxSubCategory1ID As String, ByVal TrxSubCategory2ID As String, ByVal TrxSubCategory2_1ID As String, ByVal TrxName As String,
    ...
    Public Function InsertTransactionTrmCategoryReason(ByVal TrxCategoryID As String, ByVal TrxSubCategory1ID As String, ByVal TrxSubCategory2ID As String, ByVal TrxSubCategory2_1ID As String, ByVal TrxName As String,
                                                     ByVal TrxEscalationUnit As String, ByVal TrxLayer As String, ByVal TrxSLA As String, ByVal TrxStatus As String, ByVal TrxUserName As String, ByVal TrxReasonCode As String, ByVal TrxEscalationTicket As String, ByVal TrxPriority As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
        Dim _Result As String = String.Empty
    ...
    Public Function UpdateTransactionTrmCategoryReason(ByVal TrxID As String, ByVal TrxCategoryID As String, ByVal TrxSubCategory1ID As String,
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxCategoryReason '" & TrxID & "','" & TrxCategoryID & "','" & TrxSubCategory1ID & "','" & TrxSubCategory2ID & "','" & AntiXssEncoder.HtmlEncode(TrxName.Trim, True) & "','" & TrxEscalationUnit & "','" & TrxLayer & "','" & AntiXssEncoder.HtmlEncode(TrxSLA.Trim, True) & "','" & TrxStatus & "','" & UserNameXSS & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
